...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ Tezza ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/Tezza_robot?startgroup=true"),
    ],
    [
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` Tezza [🙋‍♀️](https://telegra.ph/file/c1467c2a97c685f9ba6ad.jpg)
`ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ꜱᴘᴇᴄɪꜰɪᴄ ᴍᴏᴅᴜʟᴇꜱ..`"""

techno_IMG = "https://telegra.ph/file/aea0efe28420d9d1f6177.jpg"
    ...
    if query.data == "amelia_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Tezza*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\nIf you have any question about Tezza, let us know at @tezzasupportgroup.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
